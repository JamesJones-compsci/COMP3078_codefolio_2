    ...
    context.ResumeSections.AddRange(
        ...
        new ResumeSection
        {
            ...
            ResumeContent = "<hr>" +
                            ...
                            "<li>Cloud, Microservices & Security: Docker, REST APIs, microservices architecture, JWT authentication, OAuth2, Keycloak</li>" +
                            "<li>Cyber-Security Fundamentals: network protocols, port analysis, TCP/UDP packet tracing using Wireshark, vulnerability assessment, firewall configuration (UFW), and attack mitigation techniques</li>" +
        ...
        new ResumeSection
        {
            ...
            ResumeContent = "<hr>" +
                            ...
                            "<li>Manage business operations, including digital presence and online client engagement</li>" +
                            "</ul>"
        },
        ...
        new ResumeSection
        {
            ...
            ResumeContent = "<hr>" +
                            ...
                            "<li>Gained experience in secure backend development, responsive front-end design, and full-stack architecture best practices</li>" +
                            "</ul>" +
                            ...
                            "<li>Designed RESTful microservices, secured API communication, and containerized the environment for reproducible development</li>" +
                            ...
                            "<li>Gained experience in interpreting ML results for business decisions and debugging preprocessing pipelines</li>" +
                            "</ul>"
        }
    );
